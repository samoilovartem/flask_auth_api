...
Tokens = namedtuple("Tokens", ["access_token", "expires_in", "scope", "token_type", "id_token"])
...
class GoogleAuthProvider(SocialProvider):
    ...
    @lru_cache
    def redirect_url(self, handler_path: str, scopes: tuple = (SCOPES["email"], SCOPES["social"])):
        """
        ...
        return "{}?client_id={}&redirect_uri={}&response_type={}&scope={}".format(AUTH_URL, *params.values())
